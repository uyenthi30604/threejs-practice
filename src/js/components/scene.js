...
export default class MainScene {
  ...
  setShapes() {
    ...
    const shape1 = new Shape({ geometry: geometry1, material, parentMesh: this.#containerMesh, position: new Vector3(3, 2, 0) });
    const geometry2 = new TorusGeometry(2, 0.5, 16, 100)
    const shape2 = new Shape({ geometry: geometry2, material, parentMesh: this.#containerMesh, position: new Vector3(3, 1, -6), speed: 0.002, offsetSpeed: 10 })
    const geometry3 = new CylinderGeometry(0.5, 0.5, 2, 32)
    const shape3 = new Shape({ geometry: geometry3, material, parentMesh: this.#containerMesh, position: new Vector3(0, 2, 2), speed: 0.001, offsetSpeed: 20 })
    const geometry4 = new CylinderGeometry(0.1, 0.5, 2, 32)
    const shape4 = new Shape({ geometry: geometry4, material, parentMesh: this.#containerMesh, position: new Vector3(-4, 2, 2), speed: 0.001, offsetSpeed: 20 })
